...
const INPUT_PATH = "src/data/heat-stress/raw/cabilla_heat_stress.csv";

const BASELINE_OUTPUT_PATH =
  "src/data/heat-stress/cabilla/baseline-heat-stress.js";

const CURRENT_OUTPUT_PATH =
  "src/data/heat-stress/cabilla/current-heat-stress.js";
...
const baselineOutput = `export const cabillaBaselineHeatStress = {
  categories: ${JSON.stringify(baselineCategories, null, 4)},
};
`;

const currentOutput = `export const cabillaCurrentHeatStress = {
