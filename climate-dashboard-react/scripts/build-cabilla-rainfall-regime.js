...
const INPUT_PATH = "src/data/annual-rainfall/raw/cabilla-rainfall.csv";

const BASELINE_OUTPUT_PATH =
  "src/data/annual-rainfall/cabilla/baseline-regime.js";

const CURRENT_OUTPUT_PATH =
  "src/data/annual-rainfall/cabilla/current-regime.js";
...
const categories = [
  ...
  { key: "light", label: "Light", range: "1 - 5 mm" },
  { key: "moderate", label: "Moderate", range: "5 - 10 mm" },
  { key: "heavy", label: "Heavy", range: "> 10 mm" },
];
...
const baselineOutput = `export const cabillaBaselineRainfallRegime = {
  categories: ${JSON.stringify(baselineCategories, null, 4)},
};
`;

const currentOutput = `export const cabillaCurrentRainfallRegime = {
