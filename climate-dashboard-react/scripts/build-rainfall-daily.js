...
const CONFIGS = [
  {
    label: "Cabilla",
    placeMatch: "cabilla",
    sheetUrl: "https://docs.google.com/spreadsheets/d/e/2PACX-1vSagwLT2bTQPD0djOzNmw6FBZurQuE8-7WqL0fm4QLPUowX9TIZVAcuUpHVcwE3kIjkpcFgbXZRE3IZ/pub?gid=0&single=true&output=csv",
    output: "src/data/cabilla/aggregates/cabilla-rainfall-daily.json",
  },
  {
...
build().catch((err) => {
  console.error("Failed to build rainfall daily JSON");
  console.error(err);
  process.exit(1);
});