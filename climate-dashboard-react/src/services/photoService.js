...
import aw2025 from "@/data/photos/manifests/appleton-woods/2025.json";
import aw2026 from "@/data/photos/manifests/appleton-woods/2026.json";

// add more over time
const MANIFESTS_BY_PLACE = {
  littleknepp: [lk2025, lk2026],
  "appleton-woods": [aw2025, aw2026],
};
